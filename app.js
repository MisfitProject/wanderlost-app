...
/* Load Google Maps dynamically after auth is dismissed */
let mapsLoaded=false;
function loadMaps(){if(mapsLoaded)return;mapsLoaded=true;const s=document.createElement('script');s.src='https://maps.googleapis.com/maps/api/js?key=AIzaSyB1RVtX565j0NYmTtFebx1nmDCrh6X0rYM&libraries=places&callback=initMap';s.async=true;s.defer=true;document.head.appendChild(s);}
