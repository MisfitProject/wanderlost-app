...
const DARK=[{elementType:'geometry',stylers:[{color:'#050810'}]},{elementType:'labels.icon',stylers:[{visibility:'off'}]},{elementType:'labels.text.fill',stylers:[{color:'#2a3040'}]},{elementType:'labels.text.stroke',stylers:[{color:'#050810'}]},{featureType:'poi',elementType:'geometry',stylers:[{color:'#080c15'}]},{featureType:'poi.park',elementType:'geometry',stylers:[{color:'#071008'}]},{featureType:'road',elementType:'geometry',stylers:[{color:'#0e1420'}]},{featureType:'road',elementType:'geometry.stroke',stylers:[{color:'#1a2236'}]},{featureType:'road.highway',elementType:'geometry',stylers:[{color:'#141e30'}]},{featureType:'transit',elementType:'geometry',stylers:[{color:'#0a0f1a'}]},{featureType:'water',elementType:'geometry',stylers:[{color:'#030610'}]}];
...
Q('btn-try')?.addEventListener('click',()=>{Q('auth').classList.add('out');setTimeout(pz,400)});
